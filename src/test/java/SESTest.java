...
class SESTest {
    ...
    void print() {
        ...
        String expectedOutput  = "SES with period 1\n" +
                "F[2]: 1,000\n" +
                "F[3]: 6,172\n" +
                "F[4]: 6,170\n" +
                "F[5]: 153,852\n" +
    ...
    void calc1() {
        ...
        assertArrayEquals(expectedSes, actualSes, 0.01,"getSes() must retrieve the correct SES array");
    }
